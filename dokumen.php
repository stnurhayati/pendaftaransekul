  ...
  <div class="container">
    ...
    <form action="dokumen.php" method="post" enctype="multipart/form-data">
      ...
      <form action="upload_ktp.php" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            <button type="submit" name="simpanktp" class="btn btn-primary"> Simpan Kartu Keluarga </button>
        </div>
      </form>
      ...
      <form action="upload_ijazah.php" method="post" enctype="multipart/form-data">  
        <div class="form-group">
          <label for="exampleInputEmail1">Raport Semester 1 mulai kelas 7-9</label>
          <input type="file" name="rapot" class="form-control" >
        </div>
        <div class="form-group">
            <button type="submit" name="simpanijazah" class="btn btn-primary"> Simpan Raport</button>
        </div>
      </form>       
